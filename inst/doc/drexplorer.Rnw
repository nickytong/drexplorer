...
% \\mdadqsfs02\bioinfo2\ptong1\Projects\Coombes\IC50Package\Package\drexplorer\inst\doc
% \\mdadqsfs02\bioinfo2\ptong1\Projects\Coombes\IC50Package\Package\for_vignettes\drexplorer.Rnw
% To compile this document, run the commands within R
% require(knitr); knit2pdf("drexplorer.Rnw")
...
\section{GUI Usage}
GUI interface has been shipped with \Rpackage{drexplorer} which is built upon the \Rpackage{fgui}. After loading the \Rpackage{drexplorer} 
package, typing $$\texttt{drexplorerGUI\_1()}$$ in the R console will bring out the GUI for fitting dose-response curves. 
Similarly,  typing $$\texttt{drexplorerGUI\_2()}$$ will bring out the GUI for drug-drug interaction analysis. In both case, example
