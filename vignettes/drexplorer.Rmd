...
estimates from interpolation and prediction by the model are quite similar except for IC100 where Inf is returned since the fitted
model cannot achieve 100% killing effect (see figure below). 
...
Two papers have been published regarding to drug interaction index (IAI) by Lee et al, 
	one in 2007 (Lee2007) [Lee, J. J., Kong, M., Ayers, G. D., & Lotan, R. (2007)](#lee2007interaction) and on in 2009 (Lee2009) [Lee, J. J., & Kong, M. (2009)](#lee2009confidence). The Lee2007 paper 
...
of these models, please refer to Lee2007 [Lee, J. J., Kong, M., Ayers, G. D., & Lotan, R. (2007)](#lee2007interaction).
...
*ryegrass* data. Result files will be saved in a folder called **drexplorer_results** at the working directory of R session including:  
...
buttons. Similar to the previous GUI, input file can be either a comma-separated file or tab-delimited file. 
Three columns are needed to run this GUI. The first column is assumed to be the dose of drug 1. The
second column is assumed to be the dose of drug 2. And the last column is assumed to be response under the drug
combination. A multi-page pdf file will be generated to save various
...
<!--     rmarkdown::render('/home/ptong1/Backup/GitHub/drexplorer/inst/doc/drexplorer.Rmd')            -->
